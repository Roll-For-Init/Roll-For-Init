    ...
    return (
        <div className="container-fluid">
            <div className="mb-3 row">
                ...
                <h2 className="col-9 offset-1 py-4 mb-0 rounded">Race</h2>
            </div>
            <InfoCard children={info} />
            <div className="card row side-bar">
                ...
                <div className="card-body">
                    ...
                    <div className="card-subtitle mt-4 text-background text-left">
                        <p className="text-capitalize m-0">
                            <strong className="text-uppercase">Weapons</strong>{' '}
    ...
    return (
        <div className="card row side-bar">
            <div className="card-body">
                ...
                {Object.entries(children).map((info, idx) => {
                    return (
                        <h6 className="card-subtitle mt-4" key={idx}>
